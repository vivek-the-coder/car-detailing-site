        ...
        <main className="bg-[#030303] text-white">
            ...
            <section className="relative min-h-[70vh] flex items-center justify-center pt-24 overflow-hidden">
                ...
                <div className="container-lux relative z-10 text-center">
                    <FadeIn direction="up">
                        <p className="text-luxury-sm text-luxury-accent uppercase tracking-[0.4em] font-medium mb-6 md:mb-8">Uncompromising Standards</p>
                ...
                <div className="container-lux">
                    <div className="grid lg:grid-cols-2 gap-12 md:gap-20 items-center">
                        <FadeIn direction="right">
                            <p className="text-luxury-sm text-luxury-accent/60 uppercase tracking-[0.3em] font-medium mb-6 md:mb-8">The Philosophy</p>
                            <h2 className="text-3xl md:text-6xl font-semibold text-white mb-8 tracking-tighter uppercase italic">Our Approach</h2>
                            <p className="text-lg md:text-xl text-white/50 font-light mb-8 italic leading-relaxed">
                ...
                <div className="container-lux">
                    <div className="grid lg:grid-cols-2 gap-12 md:gap-20 items-center">
                        <FadeIn direction="right" className="lg:order-2">
                            <p className="text-luxury-sm text-luxury-accent/60 uppercase tracking-[0.3em] font-medium mb-6 md:mb-8">Controlled Studio</p>
                            <h2 className="text-3xl md:text-6xl font-semibold text-white mb-8 tracking-tighter uppercase italic">The Studio Environment</h2>
                            <p className="text-lg md:text-xl text-white/50 font-light mb-8 md:mb-10 italic leading-relaxed">
                ...
                <div className="container-lux">
                    <FadeIn direction="up">
                        <div className="text-center max-w-4xl mx-auto">
                            <p className="text-luxury-sm text-luxury-accent uppercase tracking-[0.3em] font-medium mb-6 md:mb-8">Core Expertise</p>
                            <h2 className="text-3xl md:text-6xl font-semibold mb-8 md:mb-10 tracking-tight uppercase">Professional Automotive Protection</h2>
...
function Feature({ title, description }: { title: string; description: string }) {
    return (
        <FadeIn direction="up" delay={0.1}>
            <div className="p-8 md:p-12 rounded-[2rem] md:rounded-[2.5rem] border border-white/5 bg-zinc-900/40 hover:border-luxury-accent/30 hover:bg-zinc-900/60 transition-all duration-500 group h-full">
                <div className="w-12 h-px bg-luxury-accent/40 mb-6 md:mb-8 group-hover:w-20 transition-all duration-500" />
                <h3 className="text-xl md:text-2xl font-semibold text-white mb-6 uppercase tracking-tight italic">{title}</h3>
                <p className="text-sm md:text-base text-white/40 font-light leading-relaxed group-hover:text-white/60 transition-colors">
                    {description}
                </p>
            </div>
        </FadeIn>
